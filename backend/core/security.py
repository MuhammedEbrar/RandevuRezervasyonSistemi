...
# Düzeltilecek importlar:
# 1. Sadece settings objesini backend.core.settings'ten import edin.
from backend.core.settings import settings # <-- SADECE BU KALMALI

# 2. database ve crud modüllerini de backend paketi altından import edin
from backend.database import get_db # <-- DÜZELTİLDİ
from backend.crud import user as crud_user # <-- DÜZELTİLDİ

# User model ve UserRole enum'u zaten doğru.
