...
from sqlalchemy import Column, String, Boolean, DateTime, Enum, ForeignKey, DECIMAL, Uuid
...
class Booking(Base):
    ...
    customer_id = Column(Uuid, ForeignKey("users.user_id"), nullable=False)
    ...
    parent_booking_id = Column(Uuid, ForeignKey("bookings.booking_id"), nullable=True)
