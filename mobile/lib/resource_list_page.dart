...
import 'package:mobile/add_resource_page.dart'; // Yeni sayfayı dahil ediyoruz
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<dynamic>>(
        ...
        builder: (context, snapshot) {
          // ... (FutureBuilder'ın geri kalanı aynı) ...
      ...
      // FLOATING ACTION BUTTON GÜNCELLENDİ
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // Yeni varlık ekleme sayfasına git
          Navigator.push(
            context,
